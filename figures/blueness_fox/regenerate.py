"""Render the blueness reward grid for the fox prompt (3 rows x 5 cols)."""
...
ROWS = [0, 1, 3]
PROMPT = r"``a baby fox wearing a cozy knitted sweater''"
...
fig.savefig(HERE / "blueness_fox.pdf")
fig.savefig(HERE / "blueness_fox.png")
print(f"saved -> {HERE}/blueness_fox.{{pdf,png}}")
