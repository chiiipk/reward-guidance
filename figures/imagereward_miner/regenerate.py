"""Render the ImageReward grid for the miner prompt (3 rows x 5 cols)."""
...
REPO = HERE.parents[1]
DATA = REPO / "data" / "imagereward_miner"
...
ROWS = [0, 2, 3]
PROMPT = r"``Cinematic split diorama of a miner above and below ground, helmet beam, coal dust, family dinner fading opposite''"
...
fig.savefig(HERE / "imagereward_miner.pdf")
fig.savefig(HERE / "imagereward_miner.png")
print(f"saved -> {HERE}/imagereward_miner.{{pdf,png}}")
